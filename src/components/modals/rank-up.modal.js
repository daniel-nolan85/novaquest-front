        ...
        <ModalWrapper>
          <ModalView>
            ...
            <PromotionText variant='body'>
              ...
              have propelled you to the esteemed rank of {promotedRank}. As you
              ascend to new cosmic heights, your leadership and expertise shine
              brighter than ever.
            </PromotionText>
            {promotedRank === 'Space Cadet' && (
              <PromotionText variant='body'>
                Your promotion to {promotedRank} marks not just a title but the
                beginning of your cosmic journey, reflecting your resilience and
                eagerness to explore the unknown. This promotion is a
                commendation of your commitment to stellar excellence.
              </PromotionText>
            )}
            {promotedRank === 'Star Recruit' && (
              <PromotionText variant='body'>
                Your ascension to {promotedRank} symbolizes your growing cosmic
                expertise and dedication. This promotion celebrates your
                commitment to navigating the celestial realms with increasing
                proficiency.
              </PromotionText>
            )}
            {promotedRank === 'Galactic Ensign' && (
              <PromotionText variant='body'>
                Your promotion to {promotedRank} is a testament to your evolving
                strategic brilliance and commitment to mastering the cosmic
                frontier. Embrace this promotion as a milestone in your cosmic
                odyssey.
              </PromotionText>
            )}
            ...
            {promotedRank === 'Cosmic Captain' && (
              <PromotionText variant='body'>
                ...
                navigation and command is recognized. This promotion celebrates
                your cosmic achievements and leadership in the vastness of the
                universe.
              </PromotionText>
            )}
            {promotedRank === 'Celestial Major' && (
              <PromotionText variant='body'>
                ...
                significant contributions to the cosmic frontier. This milestone
                underscores your leadership and expertise in celestial
                endeavors.
              </PromotionText>
            )}
            ...
            {promotedRank === 'Stellar General' && (
              <PromotionText variant='body'>
                With your ascension to {promotedRank}, your cosmic expertise and
                command reach new heights. This promotion recognizes your
            ...
            {promotedRank === 'Astro Admiral' && (
              <PromotionText variant='body'>
                As {promotedRank}, your mastery of cosmic navigation and command
                is unparalleled. This promotion signifies your distinguished
                service and leadership in the vast expanse of space.
              </PromotionText>
            )}
            {promotedRank === 'Cosmic Marshal' && (
              <PromotionText variant='body'>
                Your promotion to {promotedRank} is a testament to your cosmic
                authority and strategic brilliance. This milestone reflects your
                outstanding contributions to maintaining cosmic order.
              </PromotionText>
            )}
            ...
            {promotedRank === 'Astronomy Ambassador' && (
              <PromotionText variant='body'>
                As {promotedRank}, your role in representing cosmic interests is
                paramount. This promotion celebrates your contributions to
            ...
            {promotedRank === 'Cosmic Sovereign' && (
              <PromotionText variant='body'>
                ...
                cosmic realms. This promotion reflects your supreme mastery and
                leadership in the cosmic expanse.
              </PromotionText>
            )}
            <PromotionText variant='body'>
              May your cosmic adventures continue to unfold, and may the cosmos
              witness the brilliance of your leadership in the vast reaches of
              space.
            </PromotionText>
            <PromotionText variant='body'>
